# MICROSERVICES PRACTICE PROJECT :
    Developed microservices project with API-GATE and SPRING CLOUD (EUREKA). BY USING FEIGN CLIENT COMMUNICATE BTW MICROSERVICES.
...
# USER MICROSERVICE :
    ...
    * USER LOCATION CONTROLLER :-
    ...
    HIGHLITES : 
            * BY USING FEIGNCLIENT THIS MICROSERVICE COMMUNICATE WITH OTHER RESPECTIVE MICROSERVICES THAT ITEM-MICROSERVICE, ORDER-MICROSERVICE, GMAIL-MICROSERVICE,         
